...
import RecordDetailsHeader from "./record-details-header";
...
function SingleRecordDetails() {
  ...
  const processTreatmentPlan = async () => {
    ...
    const prompt = `Your role and goal is to be an that will be using this treatment plan ${analysesResult} to create Columns:
                ...
                <div className="flex w-full flex-col px-6 py-4 text-white">
                  <div>
                    ...
                    <div className="space-y-2">
                      <ReactMarkdown>{analysesResult}</ReactMarkdown>
                    </div>
                  </div>
